...
var _login = __webpack_require__(/*! ./features/login */ "./src/features/login/index.js");

var _login2 = _interopRequireDefault(_login);

var _Hello = __webpack_require__(/*! ./features/login/components/Hello */ "./src/features/login/components/Hello.js");
...
var App = function App(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { path: '/main',
...
/***/ "./src/features/login/actionCreator.js":
/*!*********************************************!*\
  !*** ./src/features/login/actionCreator.js ***!
  \*********************************************/
/*! no static exports found */
...
var _api = __webpack_require__(/*! ../../shared/api */ "./src/shared/api/index.js");
...
var login = exports.login = function login(username, password) {
    return function (dispatch) {
        ...
        _api2.default.login(body, function (response) {
...
/***/ "./src/features/login/components/Hello.js":
/*!************************************************!*\
  !*** ./src/features/login/components/Hello.js ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/features/login/components/Login.js":
/*!************************************************!*\
  !*** ./src/features/login/components/Login.js ***!
  \************************************************/
/*! no static exports found */
    ...
    _createClass(Login, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("input", { type: "text", placeholder: "username", value: this.state.user, onChange: this.handleUserChange }),
                _react2.default.createElement("br", null),
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { type: "password", placeholder: "password", value: this.state.password, onChange: this.handlePasswordChange }),
                _react2.default.createElement("br", null),
                _react2.default.createElement("br", null),
                _react2.default.createElement(
                    "button",
...
/***/ "./src/features/login/components/LoginContainer.js":
/*!*********************************************************!*\
  !*** ./src/features/login/components/LoginContainer.js ***!
  \*********************************************************/
/*! no static exports found */
...
var _Login = __webpack_require__(/*! ./Login */ "./src/features/login/components/Login.js");

var _Login2 = _interopRequireDefault(_Login);

var _reactRedux = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");

var _actionCreator = __webpack_require__(/*! ../actionCreator */ "./src/features/login/actionCreator.js");
...
var LoginContainer = function (_React$Component) {
    ...
    _createClass(LoginContainer, [{
        key: 'submit',
        value: function submit(username, passsword) {
            this.props.dispatch((0, _actionCreator.login)(username, passsword));
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(_Login2.default, { submit: this.submit });
        }
    }]);
...
exports.default = (0, _reactRedux.connect)()(LoginContainer);
...
var _LoginContainer = __webpack_require__(/*! ./components/LoginContainer */ "./src/features/login/components/LoginContainer.js");
...
var _reducer = __webpack_require__(/*! ./reducer */ "./src/features/login/reducer.js");
...
exports.default = _LoginContainer2.default;
...
var loginReducer = function loginReducer() {
    ...
    switch (action.type) {
        ...
        case "LOGIN_FAILURE":
            return _extends({}, state, { "login": "failed" });
    }
    return state;
};
...
exports.default = {
    get: function get(url, body, cb, timeout) {
        return _axios2.default.get(url, body, timeout || TIMEOUT).then(function (response) {
            cb(response);
        }).catch(function (error) {
            cb(error);
        });
    },
    post: function post(url, body, cb, timeout) {
        return _axios2.default.post(url, body, timeout || TIMEOUT).then(function (response) {
            cb(response);
        }).catch(function (error) {
            cb(error);
        });
...
var _api = __webpack_require__(/*! ../api/api */ "./src/shared/api/api.js");
...
exports.default = {
  login: function login(body, callback) {
    ...
    return _api2.default.get("/login", body, callback);
  }
};
